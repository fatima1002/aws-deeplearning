...
def net():
    ...
    ##check how many features present in output of the model
...
def create_data_loaders(args):
    ...
    trainloader = torch.utils.data.DataLoader(
        trainset,shuffle=True, batch_size=args.batch-size)
    ...
    validationloader = torch.utils.data.DataLoader(
        validationset,shuffle=False, batch_size=args.test-batch-size)
    ...
    testloader = torch.utils.data.DataLoader(
        testset,shuffle=False, batch_size=args.test-batch-size)
...
def main(args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        model = train(model, train_loader,
                ...
                hook, device)
        test(model, test_loader, hook, device)
    
    # model=train(model, trainloader, testloader, criterion, optimizer, device, args)
    ...
    '''
    path = os.path.join(model_dir, "dogbreed.pt")
